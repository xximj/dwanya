  ...
  render() {
    return (
      <div class="container-lg">
        ...
        />
        <div class="row">
          <div class="col-12 col-lg-8 offset-lg-2">{this.registerForm()}</div>
        </div>
      </div>
    );
  }
  ...
  registerForm() {
    return (
      <form onSubmit={linkEvent(this, this.handleRegisterSubmit)}>
        ...
        <div class="form-group row">
          <label class="col-sm-4 col-form-label" htmlFor="register-username">
            {i18n.t("username")}
          </label>
        ...
        <div class="form-group row">
          <label class="col-sm-4 col-form-label" htmlFor="register-email">
            {i18n.t("email")}
          </label>
          <div class="col-sm-8">
            <input
        ...
        <div class="form-group row">
          <label class="col-sm-4 col-form-label" htmlFor="register-password">
            {i18n.t("password")}
          </label>
          <div class="col-sm-8">
            <input
        ...
        {this.state.captcha && (
          <div class="form-group row">
            <label class="col-sm-4" htmlFor="register-captcha">
