...
export const repoUrl = "https://dwnya.co/tos";
export const joinLemmyUrl = "https://dwnya.co";
export const donateLemmyUrl = `${joinLemmyUrl}/donate`;
export const docsUrl = `${joinLemmyUrl}/help`;
export const helpGuideUrl = `${joinLemmyUrl}/help`; // TODO find a way to redirect to the non-en folder
...
export const elementUrl = "https://twitter.com/dwanyaco";
...
function getBrowserLanguages(): string[] {
  ...
  let langs = languages ? languages.map(l => l.code) : ["ar"];
...
export function pictrsDeleteToast(
  ...
  if (isBrowser()) {
    let backgroundColor = `var(--danger)`;
    let toast = Toastify({
